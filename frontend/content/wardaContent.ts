  ...
  "kit-collagene": {
    fr: {
      ...
      faq: [
        ...
        { q: "Quand voir les résultats du duo ?", a: "Confort et hydratation dès la première semaine ; fermeté et vergetures qui disparaissent après 4 semaines d'utilisation combinée." },
    ...
    ar: {
      ...
      faq: [
        ...
        { q: "فوقاش كتبان نتيجة الباك المزدوج؟", a: "ترطيب ونعومة فورية من الأسبوع الأول؛ والتماسك ونقص علامات التمدد مبقاوش فيا من بعد 4 الأسابيع." },
