...
export const products: Record<string, Product> = {
  velvastretch: {
    ...
    offers: [
      { qty: 1, price: 219 },
      { qty: 2, price: 279, save: 159 },
      { qty: 3, price: 329, save: 328 },
    ],
    stockCount: 47,
    hero: {
    ...
    upsellCopy: "Ajoutez le Kit Collagène Inside & Outside pour 329 MAD seulement (économisez 519 MAD)",
  ...
  silkstop: {
    ...
    offers: [
      { qty: 1, price: 209 },
      { qty: 2, price: 259, save: 159 },
      { qty: 3, price: 299, save: 328 },
    ],
    stockCount: 61,
    hero: {
    ...
    upsellCopy: "Offre duo — 2 sérums SilkStop™ à 259 MAD (économisez 159 MAD)",
    upsellSlug: "silkstop",
    upsellQty: 2,
  ...
  collaglow: {
    ...
    offers: [
      { qty: 1, price: 229 },
      { qty: 2, price: 299, save: 159 },
      { qty: 3, price: 359, save: 328 },
    ],
    stockCount: 52,
    hero: {
    ...
    upsellCopy: "VelvaStretch™ + CollaGlow™ — Inside + Outside Kit — 329 MAD",
    upsellSlug: "kit-collagene",
...
const kitCollagene: Product = {
    ...
    reviews: 1459,
    offers: [
      { qty: 1, price: 329, save: 519 },
      { qty: 2, price: 449, save: 209 },
    ],
    stockCount: 40,
    hero: {
