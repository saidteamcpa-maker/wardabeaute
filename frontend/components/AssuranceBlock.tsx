        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Reveal>
            <div className="rounded-2xl border border-brume p-5 card-hover h-full transition-shadow duration-200">
              ...
              <p className="font-body text-brun text-sm">{t(lang, "ab.safeBody")}</p>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.08}>
            <div className="rounded-2xl border border-brume p-5 card-hover h-full transition-shadow duration-200">
              ...
              <p className="font-body text-brun text-sm">{t(lang, "ab.halalBody")}</p>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.16}>
            <div className="rounded-2xl border border-brume p-5 card-hover h-full transition-shadow duration-200">
              ...
              <p className="font-body text-brun text-sm">{t(lang, "ab.guaranteeBody")}</p>
            </div>
          </Reveal>
        </div>

        <Reveal delay={0.1}>
          <div className="mt-5 rounded-2xl bg-petal border border-brume p-5 flex flex-col sm:flex-row items-center gap-4">
            <div className="flex items-center gap-3">
              <IconBadge icon={Truck} tone="warda" size="sm" />
              <span className="font-display text-profond">{t(lang, "ab.codTitle")}</span>
            </div>
            <p className="font-body text-brun text-sm flex-1">{t(lang, "ab.codBody")}</p>
            <div className="flex items-center gap-2 text-warda font-body text-sm">
