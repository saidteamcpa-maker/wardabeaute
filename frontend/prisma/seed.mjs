...
const CATALOG = [
  ...
  { slug: "kit-collagene", name: "Kit Collagène Inside & Outside", price: 549, oldPrice: 848, image: "/kit-collagene-hero.png", isBundle: true, offers: [{ qty: 1, price: 549, save: 299 }] },
];
