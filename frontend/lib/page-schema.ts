...
export const PAGE_TYPES: Record<string, PageTypeDef> = {
  ...
  product: {
    ...
    blocks: [
      ...
      b("pp.offer1Image", "Offre 1 pièce — image", "image"),
      b("pp.offer2Image", "Offre 2 pièces — image", "image"),
      b("pp.offer3Image", "Offre 3 pièces — image", "image"),
      ...
      // Gallery (new PDP)
      b("pp.gallery1", "Galerie — photo 1", "image"),
      b("pp.gallery2", "Galerie — photo 2", "image"),
      b("pp.gallery3", "Galerie — photo 3", "image"),
      b("pp.gallery4", "Galerie — photo 4", "image"),
      b("pp.gallery5", "Galerie — photo 5", "image"),
      b("pp.gallery6", "Galerie — photo 6", "image"),
      b("pp.gallery7", "Galerie — photo 7", "image"),
      b("pp.gallery8", "Galerie — photo 8", "image"),
      // Timeline (new PDP)
      b("pp.timelineEyebrow", "Timeline — sourcilline", "text"),
      b("pp.timelineTitle", "Timeline — titre", "text"),
      b("pp.timeline1", "Timeline — étape 1", "textarea"),
      b("pp.timeline2", "Timeline — étape 2", "textarea"),
      b("pp.timeline3", "Timeline — étape 3", "textarea"),
      b("pp.timelineCallout1", "Timeline — encadré 1", "textarea"),
      b("pp.timelineCallout2", "Timeline — encadré 2", "textarea"),
      b("pp.timelineDisclaimer", "Timeline — disclaimer", "textarea"),
      // Pricing (new PDP) — offers drive cards, only titles/badges are overridable
      b("pp.pricingEyebrow", "Tarifs — sourcilline", "text"),
      b("pp.pricingTitle", "Tarifs — titre", "text"),
      b("pp.pricingSaveBadge", "Tarifs — badge économie", "text"),
      // Order form (new PDP)
      b("pp.orderEyebrow", "Commande — sourcilline", "text"),
      b("pp.orderTitle", "Commande — titre", "text"),
      b("pp.orderBadges", "Commande — badges (un par ligne)", "textarea"),
    ],
  },
  faq: {
    name: "FAQ",
  ...
  kit: {
    ...
    blocks: [
      ...
      b("kit.offer1Image", "Kit 1 — image", "image"),
      b("kit.offer2Image", "Kit 2 — image", "image"),
      b("kit.scienceImage", "Science — image", "image"),
      b("kit.ingredientsImage", "Ingrédients — image", "image"),
      b("kit.ritualImage", "Rituel — image", "image"),
      // Gallery (new PDP)
      b("kit.gallery1", "Galerie — photo 1", "image"),
      b("kit.gallery2", "Galerie — photo 2", "image"),
      b("kit.gallery3", "Galerie — photo 3", "image"),
      b("kit.gallery4", "Galerie — photo 4", "image"),
      b("kit.gallery5", "Galerie — photo 5", "image"),
      b("kit.gallery6", "Galerie — photo 6", "image"),
      b("kit.gallery7", "Galerie — photo 7", "image"),
      b("kit.gallery8", "Galerie — photo 8", "image"),
      // Timeline (new PDP)
      b("kit.timelineEyebrow", "Timeline — sourcilline", "text"),
      b("kit.timelineTitle", "Timeline — titre", "text"),
      b("kit.timeline1", "Timeline — étape 1", "textarea"),
      b("kit.timeline2", "Timeline — étape 2", "textarea"),
      b("kit.timeline3", "Timeline — étape 3", "textarea"),
      b("kit.timelineCallout1", "Timeline — encadré 1", "textarea"),
      b("kit.timelineCallout2", "Timeline — encadré 2", "textarea"),
      b("kit.timelineDisclaimer", "Timeline — disclaimer", "textarea"),
      // Pricing (new PDP) — offers drive cards, only titles/badges are overridable
      b("kit.pricingEyebrow", "Tarifs — sourcilline", "text"),
      b("kit.pricingTitle", "Tarifs — titre", "text"),
      b("kit.pricingSaveBadge", "Tarifs — badge économie", "text"),
      // Order form (new PDP)
      b("kit.orderEyebrow", "Commande — sourcilline", "text"),
      b("kit.orderTitle", "Commande — titre", "text"),
      b("kit.orderBadges", "Commande — badges (un par ligne)", "textarea"),
    ],
  },
  collection: {
    name: "Collection",
