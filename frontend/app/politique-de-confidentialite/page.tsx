...
export default async function PolitiqueConfidentialite({ searchParams }: { searchParams?: { preview?: string } }) {
  ...
  const ar = (
    <>
      <p className="mt-2">
        مرحبا بك فـ Warda Beauté ! المصطلحات « نحن »، « ديالنا » كيرميو لـ Warda Beauté. كنخدمو هاد البوطيك والسيت ديالنا، بكل المعلومات والمحتوى والخدمات باش نعطيوك، كزبونة، تجربة شراء مخصصة (سمّيهم « الخدمات »).
      </p>
      <p className="mt-2">
        من تزوري السيت ديالنا ولا تستعملي الخدمات ديالنا، كتكوني قبلتي بهاد الشروط ديال الاستعمال. كان مابغيتيش تقبليهم، مخداميش الخدمات ديالنا.
      </p>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 1 – الدخول والكونط</h2>
        <p>بأنك قبلتي هاد الشروط، كتأكدي بلي عندك على الأقل سن الرشد فبلادك، ونتِ وحدك مسؤولة على السلامة ديال الكونطات ديالك وكل الأنشطة ديال الكونط ديالك. ما خاصكش تنقلي ولا تبيعي الكونط ديالك لشي واحد آخر.</p>
      </section>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 2 – المنتوجات ديالنا</h2>
        <p>كنحاوولو نمثلو المنتوجات ديالنا بصدق. أما الألوان ولا الشكل يقدر يختلف على شنو كيبان فالشاشة ديالك. جميع الوصفات يمكن يتبدلو فأي وقت بلا إنذار. كنحتافظو بالحق باش نحيو شي منتوج ولا نحدو من الكمية ديالو.</p>
      </section>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 3 – الكوماندات</h2>
        <p>كذا تديري كوماندة، كتعرّضي عرض شراء. Warda Beauté كتحتافظ بالحق باش تقبل ولا ترفض بأي سبب. الكوماندة ديالك مكتقبل غير من بعد التأكيد ديالنا. الشراء ديالك للاستعمال الشخصي برك، ماشي باش تبيعيها. الرجوع والتبديل تابعين لـ <a href="/politique-de-retour" className="underline text-warda">سياسة الرجوع والتوصيل</a>.</p>
      </section>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 4 – الأثمنة والخلاص</h2>
        <p>الأثمنة والبروموسيونات يمكن يتبدلو بلا إنذار؛ الثمن المخلّص هو اللي كينفع وقت الكوماندة. كي مكانش مكتوب غير، الأثمنة المعروضة مافيهاش مصاريف الشحن. Warda Beauté كتخدم بـ <strong>الخلاص 100% عند الاستلام</strong> : ما كتخلصي غير كيف توصلك السلعة. كتضماني بلي المعلومات ديال الكوماندة صحيحة وكاملة.</p>
      </section>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 5 – الشحن والتوصيل</h2>
        <p>التوصيل بالخاوة فكل المغرب فأقل من 24 لـ 48 ساعة. الديور هوما تقديرات ومشي مضمونين. مانكونوش مسؤولين على التأخير اللي دارو البوستا ولا شي حاجة خارجا على إرادتنا. من بعد ما تسلّم السلعة للبوستا، الخطر ديال التلف ولاّ ليك.</p>
      </section>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 6 – الملكية الفكرية</h2>
        <p>كل المحتوى (ماركات، نصوص، تصاور، فيديوهات، ديزاين) هو ملك ديال Warda Beauté ولا ديال اللي عطاها ليها، ومحمي بالقوانين المغربية والدولية ديال الملكية الفكرية. استعمال الخدمات مسموح غير للغرض الشخصي. أي نسخ ولا نشر بلا موافقة مكتوبة ممنوع.</p>
      </section>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 7 – روابط لأطراف ثالثة</h2>
        <p>الخدمات يمكن فيها روابط لسيتات ديال ناس آخرين. مانكونوش مسؤولين على المحتوى ولا الصحة ديال هادوك السيتات. أي شراء من سيت ديال آخر راه مسؤوليتك وحدك.</p>
      </section>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 8 – الاستعمالات الممنوعة</h2>
        <p>كتتعهدي تستعملي الخدمات لأغراض قانونية، وما تخرقيش القوانين، ولا حقوق الملكية ديال الناس، ولا ترسلي محتوى غير قانوني ولا مضر. نقدرو نوقفو الدخول ديالك كان خرقتي هاد الشروط.</p>
      </section>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 9 – لا ضمان على الضمانات</h2>
        <p>كي مكانش مكتوب غير، الخدمات والمنتوجات كيتعطاو « كيف ما هوما » و« كيف ما كاينين »، بلا حتى ضمان. مانضمنوش بلي استعمال الخدمات مغادي يقطعش ولا بلا غلط.</p>
      </section>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 10 – تحديد المسؤولية</h2>
        <p>فالحدود اللي كيحددها القانون، Warda Beauté مانقدروش نكونو مسؤولين على الضرر غير المباشر اللي جا من استعمال الخدمات ولا شي منتوج شرتيه.</p>
      </section>
      <section>
        <h2 className="text-2xl text-profond mb-2">القسم 11 – التعديلات</h2>
        <p>كنحتافظو بالحق باش نحدّثو هاد الشروط فأي وقت. النسخة الجديدة كتلقاها فهاد الصفحة. الاستمرار فاستعمال الخدمات من بعد النشر كيعني التقبل ديال التعديلات.</p>
      </section>
      <section>
